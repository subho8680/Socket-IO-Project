    ...
    <div className="flex flex-col items-center gap-2">
      <Avatar
        ...
        style={{
          ...
          fontSize: sizes[place] / 2.5,
          fontWeight: 700,
          border: `3px solid ${colors[place]}`,
        }}
      >
        {entry.avatar}
      </Avatar>
      <div className="text-center">
        ...
        <div className="font-black text-sm" style={{ color: colors[place] }}>
          {entry.score.toLocaleString()}
        </div>
      </div>
      <div
        className="flex items-end justify-center rounded-t-xl w-20 text-center"
        style={{
          ...
          border: `1px solid ${colors[place]}30`,
        }}
      >
      ...
      <div className="max-w-5xl mx-auto px-4 md:px-8 py-8">
        <div className="flex flex-wrap items-center justify-between gap-4 mb-8">
          <div>
            ...
            <p className="text-txt-secondary text-sm mt-0.5 font-mono">
              Room: {roomId}
            </p>
          </div>
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
          {statsRow.map((s) => (
            <div
              key={s.label}
              className="p-5 rounded-2xl text-center animate-fade-up"
              style={{ background: "#12121f", border: "1px solid #1e1e35" }}
            >
              <div className="text-xl mb-1" style={{ color: s.color }}>
                {s.icon}
              </div>
        ...
        <div
          className="p-6 rounded-2xl mb-6 animate-fade-up"
          style={{ background: "#12121f", border: "1px solid #1e1e35" }}
        >
          <h3 className="font-bold text-txt-primary text-sm mb-6 text-center">
            🏆 Top Performers
          </h3>
            ...
            {mockLeaderboard.map((entry, i) => (
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  <div className="font-semibold text-txt-primary text-sm">
                    {entry.name}
                  </div>
        ...
        >
          ...
          <div className="space-y-4">
            {mockQuestions.map((q, i) => {
              ...
              const color =
                acc >= 70 ? "#10b981" : acc >= 45 ? "#f59e0b" : "#ef4444";
              return (
                <div key={q.id}>
                  <div className="flex items-center justify-between mb-1.5">
                    <span className="text-xs text-txt-secondary truncate max-w-[70%]">
