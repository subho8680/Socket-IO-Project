...
import { BookOutlined, TeamOutlined, RocketOutlined, TrophyOutlined } from '@ant-design/icons';
        ...
        <div className='w-full max-w-[1200px] m-auto'>
          <div className='text-center mb-16'>
            ...
            <p className='text-xl text-gray-600 max-w-2xl mx-auto'>
              Transform learning experiences with AI-powered quizzes and real-time competitions
            </p>
          </div>
            ...
            <div className='group relative flex flex-col h-full d3'>
              ...
              <div className='relative p-8 bg-white rounded-2xl border border-gray-200 flex flex-col justify-between h-full hover:shadow-2xl transition-all duration-300 hover:-translate-y-2'>
                <div className='flex flex-col gap-8'>
                  ...
                  <h1 className='text-3xl font-bold text-center text-gray-800'>I am a Teacher</h1>

                  <div className='space-y-4'>
                    <p className='text-center text-lg text-gray-600 leading-relaxed'>
                      Create AI Powered Quizzes and engage your students in real time
                    </p>
                    <div className='flex justify-center items-center gap-2 text-blue-500'>
                      <RocketOutlined />
                      <span className='text-sm font-medium'>Smart Quiz Generation</span>
                    </div>
                  </div>
                </div>
            ...
            <div className='group relative flex flex-col h-full d3'>
              ...
              <div className='relative p-8 bg-white rounded-2xl border border-gray-200 flex flex-col justify-between h-full hover:shadow-2xl transition-all duration-300 hover:-translate-y-2'>
                <div className='flex flex-col gap-8'>
                  ...
                  <h1 className='text-3xl font-bold text-center text-gray-800'>I am a Student</h1>
          ...
          <div className='grid grid-cols-1 md:grid-cols-3 gap-6 mt-16 text-center'>
            <div className='p-4'>
              ...
              <p className='text-gray-600 text-sm'>Smart quiz generation with artificial intelligence</p>
            </div>
            <div className='p-4'>
              ...
              <p className='text-gray-600 text-sm'>Live competition and instant results</p>
            </div>
            <div className='p-4'>
              ...
              <p className='text-gray-600 text-sm'>Fun and interactive learning experience</p>
            </div>
          </div>
        </div>
      </div>
